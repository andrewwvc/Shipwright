...
void Horse_SetTempData(void);
void Horse_RestoreTempData(void);
void Horse_ResetTempData(void);
void EyedropEventClear(void);
void EyedropEventSet(void);
s16 EyedropEventValue(void);
...
s16 usingBorrowedWallet(void);
s16 Rupees_GetNum(void);
s16 Rupees_GetDisplayNum(void);
...
void resetGuardRupees(void);
void resetDiveRupees(void);
...
s32 Player_IsInCrouchBlock(Player* player);
