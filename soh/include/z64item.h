...
typedef enum {
    ...
    /* 0xF6 */ SLOT_TUNIC_KOKIRI = 0xF6,
    /* 0xF7 */ SLOT_TUNIC_GORON,
    /* 0xF8 */ SLOT_TUNIC_ZORA,
    /* 0xF9 */ SLOT_BOOTS_KOKIRI,
    /* 0xFA */ SLOT_BOOTS_IRON,
    /* 0xFB */ SLOT_BOOTS_HOVER,
    /* 0xFC */ SLOT_SHIELD_DEKU,
    /* 0xFD */ SLOT_SHIELD_HYLIAN,
    /* 0xFE */ SLOT_SHIELD_MIRROR,
    /* 0xFF */ SLOT_NONE = 0xFF
} InventorySlot;
