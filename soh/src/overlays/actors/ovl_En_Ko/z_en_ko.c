...
u16 func_80A96FD0(GlobalContext* globalCtx, Actor* thisx) {
    ...
    switch (ENKO_TYPE) {
        ...
        case ENKO_TYPE_CHILD_1:
            if (CHECK_QUEST_ITEM(QUEST_SONG_SARIA)) {
                //EnFish* fish = (EnFish*)Actor_FindNearby(globalCtx, &this->actor, ACTOR_EN_FISH, ACTORCAT_ITEMACTION, 2000.0f);
                s32 numF = Actor_FindNumberOf(globalCtx, &this->actor, ACTOR_EN_FISH, ACTORCAT_ITEMACTION, 2000.0f,NULL,EnFish_isFishInWater);
                if (numF) {
                    if (numF > 1) {
...
s32 backflipperAnimDrive(EnKo* this, GlobalContext* globalCtx) {
    if (IS_DAY)
...
s32 EnKo_ChildPost(EnKo* this, GlobalContext* globalCtx) {
    switch (ENKO_TYPE) {
        ...
        case ENKO_TYPE_CHILD_3:
            return func_80A97EB0(this, globalCtx);
        case ENKO_TYPE_CHILD_4:
            return backflipperAnimDrive(this, globalCtx);
        case ENKO_TYPE_CHILD_5:
            return func_80A97EB0(this, globalCtx);
        case ENKO_TYPE_CHILD_6:
            return func_80A97F20(this, globalCtx);
...
void func_80A9877C(EnKo* this, GlobalContext* globalCtx) {
    ...
    if (func_800343CC(globalCtx, &this->actor, &this->unk_1E8.unk_00, this->lookDist, func_80A97610, func_80A97738) &&
        ...
        if (func_8002F368(globalCtx) == EXCH_ITEM_ODD_POTION) {
