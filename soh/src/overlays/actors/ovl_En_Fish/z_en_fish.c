...
u8 EnFish_isFishInWater(Actor* actor, GlobalContext* globalCtx) {
...
u8 canSurvive(GlobalContext* globalCtx) {
    return globalCtx->sceneNum == 0x55;
}
...
void EnFish_Dropped_SwimAway(EnFish* this, GlobalContext* globalCtx) {
    ...
    if (this->timer < 100 && !canSurvive(globalCtx)) {
