...
void ObjMakekinsuta_WaitForBomb(ObjMakekinsuta* this, GlobalContext* globalCtx);
void ObjMakekinsuta_WaitForInsectSpecial(ObjMakekinsuta* this, GlobalContext* globalCtx);
...
void ObjMakekinsuta_WaitForInsectSpecial(ObjMakekinsuta* this, GlobalContext* globalCtx) {
    if (this->unk_152 != 0) {
        if (!func_8002DEEC(GET_PLAYER(globalCtx))) {
