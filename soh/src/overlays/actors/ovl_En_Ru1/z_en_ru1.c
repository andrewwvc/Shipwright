...
void EnRu1_Action0(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action1(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action2(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action3(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action4(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action5(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action6(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action7(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action8(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action9(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action10(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action11(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action12(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action13(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action14(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action15(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action16(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action17(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action18(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action19(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action20(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action21(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action22(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action23(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action24(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action25(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action26(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action27(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action28(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action29(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action30(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action31(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action32(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action33(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action34(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action35(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action36(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action37(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action38(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action39(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action40(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action41(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action42(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action43(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action44(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_Action45(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_NotAppearing(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_DateStart(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_DateInitialTalk(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_DateDuringTalk(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_GiveItem(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_DateFinalTalk(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_DateDuringFinalTalk(EnRu1* this, GlobalContext* globalCtx);
void EnRu1_DateEnd(EnRu1* this, GlobalContext* globalCtx);
...
s32 EnRu1_HandleMessageChoice(GlobalContext* globalCtx) {
    return (Message_GetState(&globalCtx->msgCtx) == TEXT_STATE_CHOICE) && Message_ShouldAdvance(globalCtx);
}
...
void EnRu1_ExpressDiscomfort(EnRu1* this, GlobalContext* globalCtx) {
...
void EnRu1_DetectExpressHarm(EnRu1* this, GlobalContext* globalCtx) {
    Player* player = GET_PLAYER(globalCtx);
...
void EnRu1_DetectGroundState(EnRu1* this, GlobalContext* globalCtx) {
    if (this->actor.bgCheckFlags & 1) {
        u16 groundType = SurfaceType_GetSfx(&globalCtx->colCtx, this->actor.floorPoly, this->actor.floorBgId);
        ...
        if (!inWater && isGroundHard)
            EnRu1_ExpressDiscomfort(this,globalCtx);
    }
}
...
void EnRu1_Action27(EnRu1* this, GlobalContext* globalCtx) {
    ...
    EnRu1_UpdateSkelAnime(this);
    EnRu1_UpdateEyes(this);
    EnRu1_DetectExpressHarm(this,globalCtx);
    EnRu1_DetectGroundState(this, globalCtx);
...
s32 EnRu1_DateConversation(EnRu1* this, GlobalContext* globalCtx) {
    if (!Actor_ProcessTalkRequest(&this->actor, globalCtx)) {
...
s32 func_80AEFE38(EnRu1* this, GlobalContext* globalCtx) {
    if (Message_GetState(&globalCtx->msgCtx) == TEXT_STATE_CLOSING) {
        this->actor.flags &= ~(ACTOR_FLAG_0 | ACTOR_FLAG_3);
        return true;
    } else if (EnRu1_HandleMessageChoice(globalCtx)) {
        u16 RutoMsg = GetTextID("ruto");
        ...
        Message_ContinueTextbox(globalCtx, this->actor.textId);
        return false;
    } else if (func_80AEB174(globalCtx)) {
        u16 RutoMsg = GetTextID("ruto");
        if (this->actor.textId == RutoMsg+18) {
            func_8002F434(&this->actor, globalCtx, GI_HEART_PIECE, this->actor.xzDistToPlayer + 1.0f, fabsf(this->actor.yDistToPlayer) + 1.0f);
            Message_CloseTextbox(globalCtx);
...
void EnRu1_SpotLink(EnRu1* this, GlobalContext* globalCtx, s16 relTime) {
    if (!EnRu1_HadDateStarted()) {
        ...
        s32 bgID;
        if (!BgCheck_CheckLineImpl(&globalCtx->colCtx,(1<<1),0,&headPos,&headPosLink,&result,
                        &outPoly,&bgID,&player->actor,1.0,BgCheck_GetBccFlags(1,1,1,1,1))) {
            if (relTime == -1) {
                gSaveContext.infTable[20] |= 0x2000;
                u16 RutoMsg = GetTextID("ruto");
                Message_StartTextbox(globalCtx, RutoMsg+5, NULL);
            } else if (relTime == 0) {
...
void EnRu1_DateStart(EnRu1* this, GlobalContext* globalCtx) {
    ...
    if (this->actor.speedXZ == 1.0f) {
        EnRu1_SpotLink(this, globalCtx, -1);
    }
    Actor_MoveForward(&this->actor);
...
void EnRu1_DateInitialTalk(EnRu1* this, GlobalContext* globalCtx) {
    s32 cond;
    EnRu1_SpotLink(this, globalCtx, (gSaveContext.dayTime < (49153+8192)) ? 0 : 1);
    func_80AEEF68(this, globalCtx);
    EnRu1_UpdateSkelAnime(this);
    EnRu1_UpdateEyes(this);
    func_80AEAC10(this, globalCtx);
    func_80AEAECC(this, globalCtx);
    cond = EnRu1_DateConversation(this, globalCtx);
    func_80AED624(this, globalCtx);
    if (cond) {
        this->action = 49;
    }
...
s32 EnRu1_IsWillingToSit(EnRu1* this, GlobalContext* globalCtx) {
    s32 frameCount;
...
void EnRu1_DateDuringTalk(EnRu1* this, GlobalContext* globalCtx) {
    EnRu1_UpdateSkelAnime(this);
    EnRu1_UpdateEyes(this);
    if (func_80AEB174(globalCtx) && !EnRu1_IsWillingToSit(this, globalCtx)) {
        Message_CloseTextbox(globalCtx);
        this->drawConfig = 1;
        this->actor.flags |= ACTOR_FLAG_0 | ACTOR_FLAG_3;
        this->action = 48;
...
s32 EnRu1_DateEndConversation(EnRu1* this, GlobalContext* globalCtx) {
    if (!Actor_ProcessTalkRequest(&this->actor, globalCtx)) {
        u16 RutoMsg = GetTextID("ruto");
        this->actor.flags |= ACTOR_FLAG_0 | ACTOR_FLAG_3;
...
void EnRu1_DateFinalTalk(EnRu1* this, GlobalContext* globalCtx) {
    ...
    func_80AEAC10(this, globalCtx);
    func_80AEAECC(this, globalCtx);
    cond = EnRu1_DateEndConversation(this, globalCtx);
    func_80AED624(this, globalCtx);
    if (cond) {
        this->action = 52;
    }
...
void EnRu1_LakeDateSpawn(EnRu1* this, GlobalContext* globalCtx) {
    s8 actorRoom;
    if (LINK_IS_CHILD) {
    ...
    if (0x57 == globalCtx->sceneNum) {
        ...
        if (EnRu1_DateConditionsMet()) {
            if (!(this->dateProgress & 0x1) &&
                ...
                Message_StartTextbox(globalCtx, RutoMsg+6, NULL);
            }

            if (!(this->dateProgress & 0x2) &&
                -3205 < cPos.x && cPos.x < -2885 &&
                5915 < cPos.z && cPos.z < 6235 &&
                (Actor_FindNearby(globalCtx,thisx,ACTOR_EN_OWL,ACTORCAT_NPC,300.0f) != NULL)) {

                this->dateProgress |= 0x2;
                gSaveContext.infTable[21] |= 0x40;
                Message_StartTextbox(globalCtx, RutoMsg+7, NULL);
            }
            ...
            if (!(this->dateProgress & 0x4) &&
                ...
                Message_StartTextbox(globalCtx, RutoMsg+8, NULL);
            }
        } else {
                    ...
                    if ((this->dateProgress & 0x4) &&
                        ...
                        if (EnRu1_IsNotBehindTree(cPos)) {
                            if (this->actor.xzDistToPlayer < 100.0f){
                                ...
                                if (EnRu1_DetermineDatePreScore() < 1000)
                                    Message_StartTextbox(globalCtx, RutoMsg+10, NULL);
                                else
                                    Message_StartTextbox(globalCtx, RutoMsg+11, NULL);
                            } else {
                                gSaveContext.infTable[20] |= 0x100;
                                Message_StartTextbox(globalCtx, RutoMsg+19, NULL);
                            }
                        } else {
                            gSaveContext.infTable[20] |= 0x100;
                            Message_StartTextbox(globalCtx, RutoMsg+26, NULL);
                        }
                    } else {
                        gSaveContext.infTable[20] |= 0x100;
                        Message_StartTextbox(globalCtx, RutoMsg+9, NULL);
                    }
...
void EnRu1_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    switch (func_80AEADF0(this)) {
        ...
        case 10:
            ...
            break;
        case 11:
            EnRu1_LakeDateSpawn(this, globalCtx);
            break;
        default:
            Actor_Kill(&this->actor);
