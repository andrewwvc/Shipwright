...
void func_80A74E2C(EnIk* this) {
    ...
    this->actor.speedXZ = 0.0f;
    this->pauseFrame = 2;
    Animation_Change(&this->skelAnime, &gIronKnuckleVerticalAttackAnim, OVERHEAD_SPEED, 0.0f, frames, ANIMMODE_ONCE, -4.0f);
...
void func_80A751C8(EnIk* this) {
    ...
    this->pauseFrame = 5;
    this->actor.speedXZ = 0.0f;
    Animation_Change(&this->skelAnime, &gIronKnuckleSkelGironknucklehorizontalattackanimAnim, 0.0f, 0.0f,
                     frames, ANIMMODE_ONCE_INTERP, -6.0f);
    this->unk_2FC = 0;
...
void EnIk_SetupLowSweep(EnIk* this) {
    ...
    this->pauseFrame = 6;
    this->actor.speedXZ = 0.0f;
    Animation_Change(&this->skelAnime, &gIronKnuckleSkelGironknucklehorizontalattackanimAnim, 0.0f, 13.0f,
                     frames, ANIMMODE_ONCE_INTERP, -6.0f);
    this->unk_2FC = 0;
    EnIk_SetupAction(this, func_80A75260);
}
...
void func_80A754A0(EnIk* this) {
    ...
    this->unk_2FF = 3;
    this->actor.speedXZ = 0.0f;
    Animation_Change(&this->skelAnime, &gIronKnuckleSkelGironknucklehorizontalattackanimAnim, 0.5f, 13.0f,
                     frames, ANIMMODE_ONCE_INTERP, -4.0f);
