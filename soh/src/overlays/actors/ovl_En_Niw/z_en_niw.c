...
void EnNiw_ResetAction(EnNiw* this, PlayState* play) {
    ...
    switch (this->actor.params) {
        ...
        case 0x10:
            ...
            this->actor.flags |= (ACTOR_FLAG_ATTENTION_ENABLED | ACTOR_FLAG_FRIENDLY | ACTOR_FLAG_DRAW_CULLING_DISABLED | ACTOR_FLAG_REACT_TO_LENS | ACTOR_FLAG_LOCK_ON_DISABLED);
