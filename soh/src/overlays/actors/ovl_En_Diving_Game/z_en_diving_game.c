...
void EnDivingGame_Await_Gift_Heart(EnDivingGame* this, GlobalContext* globalCtx);
void EnDivingGame_Start_Gift_Heart(EnDivingGame* this, GlobalContext* globalCtx);
void EnDivingGame_Finish_Gift_Heart(EnDivingGame* this, GlobalContext* globalCtx);
...
void EnDivingGame_Start_Gift_Heart(EnDivingGame* this, GlobalContext* globalCtx) {
    ...
    if ((this->unk_292 == Message_GetState(&globalCtx->msgCtx) && Message_ShouldAdvance(globalCtx))) {
        Message_CloseTextbox(globalCtx);
        this->actor.parent = NULL;
        func_8002F434(&this->actor, globalCtx, GI_HEART_PIECE, 90.0f, 10.0f);
