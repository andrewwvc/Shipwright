...
#include "overlays/actors/ovl_Obj_Timeblock/z_obj_timeblock.h"
    ...
    if (IS_RACING) {
        ...
        if (this->raceStatus == 0) {
            if (HIGH_PATH == 1)
                ...
                EnGo2* partner = NULL;
                Actor_FindNumberOf(globalCtx, &this->actor, ACTOR_EN_GO2, ACTORCAT_NPC, 3000, (Actor**)&partner, NULL);
    ...
    if (msgState == TEXT_STATE_CLOSING) {
        ...
        if (Message_ShouldAdvance(globalCtx)) {
            if (this->actor.textId == GoronMsg+6) {
                ...
                this->actionFunc = EnGo2_SetupGetItem;
                EnGo2_GetItem(this, globalCtx, GI_HEART_PIECE);
                Message_CloseTextbox(globalCtx);
...
u16 EnGo2_GetTextIdGoronMarketBazaar(GlobalContext* globalCtx, EnGo2* this) {
    u16 GoronMsg = GetTextID("goron");
    if (globalCtx->sceneNum == SCENE_SHOP1) {
        if (IS_DAY)
            return 0x7122;
        else
            return GoronMsg+16;
...
s32 func_80A44790(EnGo2* this, GlobalContext* globalCtx) {
    if ((this->actor.params & GORON_IDENTITY_PARAM) != GORON_DMT_BIGGORON && (this->actor.params & GORON_IDENTITY_PARAM) != GORON_CITY_ROLLING_BIG) {
        return func_800343CC(globalCtx, &this->actor, &this->unk_194.unk_00, this->unk_218, EnGo2_GetTextId,
                             EnGo2_GetState);
    } else if (((this->actor.params & GORON_IDENTITY_PARAM) == GORON_DMT_BIGGORON) && ((this->collider.base.ocFlags2 & 1) == 0)) {
        return false;
    } else {
...
void EnGo2_SetColliderDim(EnGo2* this) {
    u8 index = this->actor.params & GORON_IDENTITY_PARAM;
...
void EnGo2_CheckCollision(EnGo2* this, GlobalContext* globalCtx) {
    ...
    xzDist = D_80A4816C[this->actor.params & GORON_IDENTITY_PARAM].xzDist;
    pos.x += (s16)(xzDist * Math_SinS(this->actor.shape.rot.y));
    pos.z += (s16)(xzDist * Math_CosS(this->actor.shape.rot.y));
    pos.y += D_80A4816C[this->actor.params & GORON_IDENTITY_PARAM].yDist;
...
s32 func_80A44AB0(EnGo2* this, GlobalContext* globalCtx) {
    ...
    if ((this->actor.params & GORON_IDENTITY_PARAM) == GORON_DMT_BIGGORON) {
        return false;
    } else {
...
void EnGo2_PerformPathSelection(EnGo2* this, GlobalContext* globalCtx, Path *switchPath, s8 switchWaypoint, SlantCylinder* scForward, u32 lengthForward, SlantCylinder* scAlt, u32 lengthAlt) {
    Player* player = GET_PLAYER(globalCtx);
...
void EnGo2_PerformPathSelection3D(EnGo2* this, GlobalContext* globalCtx, Path *switchPath, s8 switchWaypoint, SlantCylinder* scForward, u32 lengthForward, SlantCylinder* scAlt, u32 lengthAlt) {
    Player* player = GET_PLAYER(globalCtx);
    u8 forwardCollision = 0;
    u8 altCollision = 0;
...
void EnGo2_Alter_BigRoller_Path(EnGo2* this, GlobalContext* globalCtx) {
    Player* player = GET_PLAYER(globalCtx);
    ...
    if (oldPath == &EnGo2_Special_Path[0]) {
        if ((this->waypoint == 2)) {
            ...
            EnGo2_PerformPathSelection(this,globalCtx,&EnGo2_Special_Path[5],0,scDrop5Forwards,1,scDrop5Alt,1);
        } else if (this->waypoint == 6) {
            EnGo2_PerformPathSelection3D(this,globalCtx,&EnGo2_Special_Path[9],0,scBottom9Forwards,1,scbottom9Alt,1);
        } else if (this->waypoint == 16) {
            EnGo2_PerformPathSelection(this,globalCtx,&EnGo2_Special_Path[10],0,scMid10Forwards,1,scMid10Alt,1);
        } else if (this->waypoint == 20) {
            EnGo2_PerformPathSelection(this,globalCtx,&EnGo2_Special_Path[8],0,scHtR8Forwards,1,scHtR8Alt,1);
        } else if (this->waypoint == 22) {
            EnGo2_PerformPathSelection(this,globalCtx,&EnGo2_Special_Path[0],9,scMidDown12Forwards,1,scMidDown12Alt,1);
        }
    } else if (oldPath == &EnGo2_Special_Path[3]) {
        if (this->waypoint == 0)
            this->path = &EnGo2_Special_Path[0];
        else if (this->waypoint == 3) {
            EnGo2_PerformPathSelection(this,globalCtx,&EnGo2_Special_Path[4],1,scForwards3,2,scAlt3,1);
        }
        ...
        if (this->waypoint == 0) {
            ...
            EnGo2_PerformPathSelection(this,globalCtx,&EnGo2_Special_Path[0],11,scDrop6Forwards,1,scDrop6Alt,1);
        } else if (this->waypoint == 7) {
            EnGo2_PerformPathSelection(this,globalCtx,&EnGo2_Special_Path[0],16,scRtH7Forwards,1,scRtH7Alt,1);
        }
...
s32 EnGo2_UpdateWaypoint(EnGo2* this, GlobalContext* globalCtx) {
    ...
    if (this->reverse) {
        ...
        if ((this->actor.params & GORON_IDENTITY_PARAM) == GORON_CITY_ROLLING_BIG) {
            EnGo2_Alter_BigRoller_Path(this,globalCtx);
        }
    }
...
s32 EnGo2_IsWakingUp(EnGo2* this) {
    s16 yawDiff;
    f32 xyzDist = (this->actor.params & GORON_IDENTITY_PARAM) == GORON_DMT_BIGGORON ? 800.0f : 200.0f;
...
s32 EnGo2_IsRollingOnGround(EnGo2* this, s16 arg1, f32 arg2, s16 arg3) {
    ...
    if (this->unk_59C >= 2) {
        Audio_PlayActorSound2(&this->actor, (this->actor.params & GORON_IDENTITY_PARAM) == GORON_CITY_ROLLING_BIG
...
void func_80A45288(EnGo2* this, GlobalContext* globalCtx) {
    ...
    if (this->actionFunc != EnGo2_GoronFireGenericAction) {
        ...
        this->unk_194.unk_14 = D_80A482D8[this->actor.params & GORON_IDENTITY_PARAM][linkAge];
...
f32 EnGo2_GetTargetXZSpeed(EnGo2* this, GlobalContext* globalCtx) {
    f32 yDist = (this->actor.params & GORON_IDENTITY_PARAM) == GORON_DMT_BIGGORON ? 400.0f : 60.0f;
    ...
    if (index == GORON_CITY_LINK ) {
        ...
        if (index == GORON_CITY_ROLLING_BIG) {
            if (LINK_IS_ADULT)
                return 6.0f;
            else if (globalCtx->sceneNum == 0x60)
                return 8.0f;
            else
                return 3.6000001f;
        }
...
s32 EnGo2_IsCameraModified(EnGo2* this, GlobalContext* globalCtx) {
    ...
    if ((this->actor.params & GORON_IDENTITY_PARAM) == GORON_FIRE_GENERIC || (this->actor.params & GORON_IDENTITY_PARAM) == GORON_CITY_ROLLING_BIG ||
        (this->actor.params & GORON_IDENTITY_PARAM) == GORON_CITY_STAIRWELL || (this->actor.params & GORON_IDENTITY_PARAM) == GORON_DMT_BIGGORON ||
        (this->actor.params & GORON_IDENTITY_PARAM) == GORON_MARKET_BAZAAR) {
        return true;
...
void EnGo2_GetDustData(EnGo2* this, s32 index2) {
    s32 index1 = (this->actor.params & GORON_IDENTITY_PARAM) == GORON_CITY_ROLLING_BIG ? 1 : 0;
...
void EnGo2_StopRolling(EnGo2* this, GlobalContext* globalCtx) {
    ...
    if (((this->actor.params & GORON_IDENTITY_PARAM) != GORON_CITY_ROLLING_BIG) && ((this->actor.params & GORON_IDENTITY_PARAM) != GORON_CITY_LINK)) {
        if ((this->actor.params & GORON_IDENTITY_PARAM) == GORON_DMT_ROLLING_SMALL) {
...
s32 EnGo2_IsFreeingGoronInFire(EnGo2* this, GlobalContext* globalCtx) {
    if ((this->actor.params & GORON_IDENTITY_PARAM) != GORON_FIRE_GENERIC) {
        return false;
    }
...
s32 EnGo2_IsGoronDmtBombFlower(EnGo2* this) {
    if ((this->actor.params & GORON_IDENTITY_PARAM) != GORON_DMT_BOMB_FLOWER || this->unk_194.unk_00 != 2) {
        return false;
    }
...
s32 EnGo2_IsGoronRollingBig(EnGo2* this, GlobalContext* globalCtx) {
    if ((this->actor.params & GORON_IDENTITY_PARAM) != GORON_CITY_ROLLING_BIG || (this->unk_194.unk_00 != 2)) {
        return false;
    }
    this->unk_194.unk_00 = 0;
...
s32 EnGo2_IsGoronFireGeneric(EnGo2* this) {
    if ((this->actor.params & GORON_IDENTITY_PARAM) != GORON_FIRE_GENERIC || this->unk_194.unk_00 == 0) {
        return false;
    }
...
s32 EnGo2_IsGoronLinkReversing(EnGo2* this) {
    if ((this->actor.params & GORON_IDENTITY_PARAM) != GORON_CITY_LINK || (this->waypoint >= this->unk_216) ||
...
void EnGo2_GoronLinkAnimation(EnGo2* this, GlobalContext* globalCtx) {
    ...
    if ((this->actor.params & GORON_IDENTITY_PARAM) == GORON_CITY_LINK) {
...
void EnGo2_BiggoronAnimation(EnGo2* this) {
    if (INV_CONTENT(ITEM_TRADE_ADULT) >= ITEM_SWORD_BROKEN && INV_CONTENT(ITEM_TRADE_ADULT) <= ITEM_EYEDROPS &&
        (this->actor.params & GORON_IDENTITY_PARAM) == GORON_DMT_BIGGORON && this->unk_194.unk_00 == 0) {
...
u8 isTimeblockVisible(Actor* timeblock, GlobalContext* globalCtx) {
    ObjTimeblock* this = (ObjTimeblock*) timeblock;
    return this->isVisible;
}

Actor* EnGo2_findCloseTimeblock(Actor* thisx, GlobalContext* globalCtx, f32 dist) {
    EnGo2* this = (EnGo2*)thisx;
    Actor* closestValidBlock = NULL;
    s32 numBlocks = Actor_FindNumberOf(globalCtx, thisx, ACTOR_OBJ_TIMEBLOCK, ACTORCAT_ITEMACTION, dist,
...
void EnGo2_evaluateCloseTimeblock(Actor* thisx, GlobalContext* globalCtx) {
    EnGo2* this = (EnGo2*)thisx;
    Actor* closestValidBlock = NULL;
    s32 numBlocks = Actor_FindNumberOf(globalCtx, thisx, ACTOR_OBJ_TIMEBLOCK, ACTORCAT_ITEMACTION, 100.0f,
                        &closestValidBlock, isTimeblockVisible);
...
void EnGo2_evaluateCloseTimeblock_Big(Actor* thisx, GlobalContext* globalCtx) {
    EnGo2* this = (EnGo2*)thisx;
    Actor* closestValidBlock = NULL;
    s32 numBlocks = Actor_FindNumberOf(globalCtx, thisx, ACTOR_OBJ_TIMEBLOCK, ACTORCAT_ITEMACTION, 150.0f,
                        &closestValidBlock, isTimeblockVisible);
...
void EnGo2_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (tempPath == 0x1F)
        ...
        this->path = Path_GetByIndex(globalCtx, tempPath, 0x1F);
    this->getItemEntry = (GetItemEntry)GET_ITEM_NONE;
    this->timeBlock = NULL;
    this->raceStatus = 0; //Normal race ending
    EnGo2_findCloseTimeblock(thisx,globalCtx,100.0f);
    ...
    switch (this->actor.params & GORON_IDENTITY_PARAM) {
        ...
        case GORON_CITY_LINK:
            ...
            break;
        case GORON_CITY_ROLLING_BIG:
            if ((LINK_IS_ADULT && ((!LINK_IS_ADULT ^ !!(gSaveContext.goronTimeStatus & (1<<8))) || ((globalCtx->sceneNum == SCENE_SPOT18) && IS_NIGHT))) ||
                        (!LINK_IS_ADULT && (globalCtx->sceneNum == 0x60) && !(gSaveContext.goronTimeStatus & (1<<8)))) {
                Actor_Kill(&this->actor);
            }
        //FALLTHROUGH
        case GORON_DMT_ROLLING_SMALL:
...
void EnGo2_CurledUp(EnGo2* this, GlobalContext* globalCtx) {
    ...
    if (((this->actor.params & GORON_IDENTITY_PARAM) != GORON_FIRE_GENERIC) && EnGo2_IsWakingUp(this)) {
        EnGo2_WakeUp(this, globalCtx);
    }
}
...
void EnGo2_SlowRolling(EnGo2* this, GlobalContext* globalCtx) {
    ...
    if (!EnGo2_IsRolling(this)) {
        ...
        index = this->actor.params & GORON_IDENTITY_PARAM;
        if (index != GORON_CITY_LINK) {
            if ((index == GORON_DMT_ROLLING_SMALL) && (orientation == 1) && (this->waypoint == 0)) {
                EnGo2_StopRolling(this, globalCtx);
                return;
            }
            if ((index == GORON_CITY_ROLLING_BIG) && (orientation == 1) && (this->path == &EnGo2_Special_Path[4]) && ((this->waypoint == 0) || (this->waypoint == 3 && EnGo2_findCloseTimeblock(&this->actor,globalCtx,250.0f)))) {
                EnGo2_StopRolling(this, globalCtx);
                this->path = &EnGo2_Special_Path[3];
                this->waypoint = 3;
                return;
        ...
        Math_ApproachF(&this->actor.speedXZ, EnGo2_GetTargetXZSpeed(this,globalCtx), 0.4f, 0.6f);
        this->actor.shape.rot = this->actor.world.rot;
    }
}
...
void EnGo2_Update(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (this->actor.params & GORON_SPECIAL)
        EnGo2_evaluateCloseTimeblock(thisx,globalCtx);
    else if ((this->actor.params & GORON_IDENTITY_PARAM) == GORON_CITY_ROLLING_BIG)
        EnGo2_evaluateCloseTimeblock_Big(thisx,globalCtx);
