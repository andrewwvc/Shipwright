...
void func_80ADA35C(EnPoSisters* this, PlayState* play) {
    ...
    this->actor.world.pos.y += (2.0f + 0.5f * Rand_ZeroOne()) * (CVarGetInteger(CVAR_ENHANCEMENT("NonGyroDifficulty"), 0) ? 1 : Math_SinS(this->unk_196 * STOP_PULSE_RATE));
            ...
            if (this->unk_195 == 0) {
                if (ABS((s16)(16 - this->unk_196)) < 14) {
                    ...
                    this->actor.shape.rot.y +=
                        (0x580 - (this->unk_19C * 0x180)) * ((CVarGetInteger(CVAR_ENHANCEMENT("NonGyroDifficulty"), 0) ? orbitRate/2 : fabsf(Math_SinS(this->unk_196 * STOP_PULSE_RATE))*orbitRate));
                }
