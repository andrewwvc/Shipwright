...
bool operator==(const SOH::ActorEntry& lhs, const SOH::ActorEntry& rhs)
{
...
void copyActorSpawn(ActorSpawnEnt& lhs, const SOH::ActorEntry& rhs) {
    lhs.actorNum = rhs.id;
    lhs.posX = rhs.pos.x;
    lhs.posY = rhs.pos.y;
    lhs.posZ = rhs.pos.z;
...
const std::map<u16, std::map<u16, std::vector<std::tuple<int, int, SOH::ActorEntry>>>> sceneActorOverrides = {
    ...
    { SCENE_SHADOW_TEMPLE, { // Shadow Temple
        ...
        { 0x07, {
            ...
            { -1, 1, { ACTOR_EN_RD, 3212,-543,726, 0,-32768,0, 32764}},
        } },
        { 21, {
    ...
    { SCENE_ZORAS_RIVER, { // Zora's River
        { 0x00, {
            ...
            { 0, 62, { ACTOR_OBJ_BOMBIWA, -240,363,-820, 0,-25850,1, 0x0008 }},
            { 0, 63, { ACTOR_OBJ_BOMBIWA, -240,363,-880, 0,16384,1, 0x0009 }},
            { 0, 64, { ACTOR_OBJ_BOMBIWA, -130,325,-820, 0,0,1, 0x000A }},
            { 0, -1, { ACTOR_OBJ_BOMBIWA, -130,325,-880, 0,-25850,1, 0x000B }},
            { 1, 57, { ACTOR_EN_MS, -582,375,-438, 0,16384,0, static_cast<int16_t>(0xFFFF) }},
            { 1, 60, { ACTOR_OBJ_BOMBIWA, 838,210,-194, 0,-20771,1, 0x0002 }},
            { 1, 62, { ACTOR_OBJ_BOMBIWA, -240,363,-820, 0,-25850,1, 0x0008 }},
            { 1, 63, { ACTOR_OBJ_BOMBIWA, -240,363,-880, 0,16384,1, 0x0009 }},
            { 1, 64, { ACTOR_OBJ_BOMBIWA, -125,325,-820, 0,0,1, 0x000A }},
            { 1, -1, { ACTOR_OBJ_BOMBIWA, -125,325,-880, 0,-25850,1, 0x000B }},
        } },
    } },
    { 0x59, { // Zora's Fountain
        { 0x00, {
            ...
            { 2, -1, { ACTOR_OBJ_MAKEKINSUTA, -253,32,-834, 0, 0, 3, 0x3 }}, { 3, -1, { ACTOR_OBJ_MAKEKINSUTA, -253,32,-834, 0, 0, 3, 0x3 }},
        } },
    } },
    { 0x5A, {//Gerudo Valley
        { 0x00, {
...
const std::map<u16,  std::vector<std::tuple<int, int, SOH::TransitionActorEntry>>> sceneTransitionActorOverrides = {
    { 0x5B, { // Lost Woods
