...
const std::vector<FlagTable> flagTables = {
    { "Event Check Inf Flags",
      ...
      0x0D,
      {
          ...
          { 0x2D, "Swapped out a ring" },
          { 0x2E, "Found more rings than you have equip slots" },
          ...
          { 0xCA, "Obtained Skulltula 6th Reward" },
          { 0xCB, "Obtained Skulltula 7th Reward" },
          ...
          { 0xDF, "Obtained Skulltula House's Father's Rupee" },
      } },
    { "Item Get Inf Flags",
      ITEM_GET_INF,
      0x03,
      {
          ...
          { 0x14, "Obtained Kokiri Pond Heart Piece" },
          ...
          { 0x20, "Obtained Forest Planting Heart Piece" },
          { 0x21, "Obtained Night Shop Piece" },
    ...
    { "Inf Flags",
      ...
      0x1D,
      {
          ...
          { 0x30, "Mido's house is 'bugged'" },
          { 0x31, "Spoke to Mido about the bugs" },
          { 0x33, "Spoke to Mido about forgiving Link." },
          { 0x35, "Allowed Mido to speak to Saria" },
          { 0x3F, "Spoke to the girl about the prank" },
