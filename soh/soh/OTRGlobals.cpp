...
std::unordered_map<ItemID, GetItemID> ItemIDtoGetItemIDMap{
    ...
    { ITEM_EXTRA_MAGIC, GI_EXTRA_MAGIC},
    { ITEM_EPONA_BOOST, GI_EPONA_BOOST},
    { ITEM_DEFENSE_HEART, GI_DEFENSE_HEART},
    { ITEM_WALLET_KING, GI_WALLET_KING},
    { ITEM_LANDMINE, GI_LANDMINE},
    { ITEM_NAYRUS_AFFECTION, GI_NAYRUS_AFFECTION},
    { ITEM_DINS_CRUCIBLE, GI_DINS_CRUCIBLE},
    { ITEM_BOTTLE_AMMO, GI_BOTTLE_AMMO},
    { ITEM_RING_1, GI_RING},
};
