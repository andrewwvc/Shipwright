...
extern "C" void VanillaItemTable_Init() {
    static GetItemEntry getItemTable[] = {
        ...
        GET_ITEM(ITEM_RING_1,           OBJECT_GI_CLOTHES,       GID_KEY_SMALL,        0x817, 0x80, CHEST_ANIM_SHORT,ITEM_CATEGORY_LESSER,          MOD_NONE, GI_RING_1),
        GET_ITEM(ITEM_RING_1,           OBJECT_GI_CLOTHES,       GID_KEY_SMALL,        0x817, 0x80, CHEST_ANIM_SHORT,ITEM_CATEGORY_LESSER,          MOD_NONE, GI_RING_2),
